...
import { SectionNavigation } from "../listeLignebudgetaire/ligneBudgetaire";
...
const AddNewBudgetLine = () => {
  ...
  const { isEditing, budgetLine } = useAppSelector(
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      ...
      router.push(`/grants/ligneBudgetaire/${id}/listeLignebudgetaire`);
    } catch (error) {
        ...
        initialValues={
          isEditing
            ...
            : {
                ...
                configOrganisationId: isEditing
                  ? budgetLine?.configOrganisationId
                  : null,
                configBudgetLineId: isEditing
                  ? budgetLine?.configBudgetLineId
                  : null,
              }
        }
              ...
              <NavigationContainer>
                ...
                >
                  <Stack flexDirection={"row"}>
                    <Link
                      href={`/grants/ligneBudgetaire/${id}/listeLignebudgetaire`}
                    >
                      <Button
                        color="info"
                        variant="text"
